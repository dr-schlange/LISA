...
- **Up to 8 Voices Polyphony** at 48000 sampling rate (depending on the engine, some will handle only 5 or 7 properly, unison mode is up to 4 voices only). 
...
- 2026-xx-xx - LISA v0.3.0 Architecture changes
